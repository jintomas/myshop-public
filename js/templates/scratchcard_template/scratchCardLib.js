...
var ScratchCard = function (options) {
  ...
  this.coverImageSrc=options.coverImageSrc;
...
ScratchCard.prototype.init = function (canvasID) {
  ...
  // this.myimg = document.getElementById('lamp');
...
ScratchCard.prototype.reset = function () {
  ...
  this.coverImage.onload = () => {
	this.ctx.drawImage(this.coverImage, 0, 0, this.coverImage.width,    this.coverImage.height,     // source rectangle
                   0, 0, this.ctx.canvas.width, this.ctx.canvas.height);		
		
    };

  this.coverImage.src=this.coverImageSrc;
  //this.coverImage.crossOrigin='anonymous'; 
  
	
  // this.myimage1.width=
  // this.myimage1.height=
  /* var myimg = new Image();
  
   myimg.src = "IMG-4.jpeg";
   //myimg.crossOrigin = "anonymous";
   myimg.onload = () => {
	 this.ctx.fillStyle = this.ctx.createPattern(myimg, "no-repeat");
   this.ctx.fillRect(0, 0, this.ctx.canvas.width, this.ctx.canvas.height);		
		
    }; */
  
   //this.myimg.width = this.ctx.canvas.width;
  // this.myimg.height = this.ctx.canvas.height;
  
  //var pat = this.ctx.createPattern(this.myimg, "no-repeat");
