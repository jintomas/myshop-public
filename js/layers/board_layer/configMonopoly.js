monopoly.origpages = {
    "EnterLanguagePage": [
        ...
        },*/
        {
            "templateId": 1,
            "templateType": "static",
            "src": "<div id=\"languageDetails\" style=\"cursor:pointer\"  onclick=\"monopoly.chooseLanguage('simple_chinese')\"><label style=\"color:white;cursor:pointer\" for\"simple_chinese\">Simple Chinese || 简体中文</label></div>",
            "style": "position:absolute; width:70%;padding:10px;border-radius:5px;top:30%;margin-left:15%; background-color:black;"
        },
        /*{
            "templateId":2,
            "templateType":"static",
...
//    },
        {
            "templateId": 1,
            "templateType": "static",
            "src": "<div style=\"margin-bottom:2%;\">{{noOfWeeks}}<input type=\"radio\" name=\"noOfWeeks\" value=\"3\">3 <input type=\"radio\" name=\"noOfWeeks\" value=6 checked=\"\">6</div><div id=\"enterOnlinePlayers\">{{enterOfflinePlayers}} <select id=\"num_online_players\"   onchange=\"monopoly.initOnlinePlayers()\"> " +
