...
monopoly.chooseLanguage = function (language) {
    ...
    jsElm.onload = function () {
        ...
        if (flag == true) {
            ...
            monopoly.pages.WelcomePage[1].src = "<img src=\"images/" + languageSelected + "/logo.png\" style=\"height: 39vh;top:40%;margin: 6%;margin-left: 40%;\"> </img>";
...
ubsApp.initializeLeaderBoard = function (category) {
    ...
    if (category == "Score") {
        ...
        for (var j = 0; j < parseInt(numplayers); j++) { 	//new
